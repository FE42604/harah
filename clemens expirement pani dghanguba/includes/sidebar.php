...
<div class="sidebar">
    ...
    <div class="nav flex-column mt-3">
        ...
        <?php if ($_SESSION['job_name'] === 'Stock Clerk'): ?>
            ...
            <a class="nav-link <?php echo $current_page === 'back_order.php' ? 'active' : ''; ?>" 
               href="../../roles/stock_clerk/back_order.php">
               <i class="bi bi-arrow-counterclockwise"></i>
                <span>Back Orders</span>
            </a>

            <a class="nav-link <?php echo $current_page === 'return.php' ? 'active' : ''; ?>" 
               href="../../roles/stock_clerk/return.php">
